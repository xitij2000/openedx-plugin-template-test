...
"""
test-template-plugin documentation build configuration file.
...
project = 'test-template-plugin'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'Test Template Plugin'
...
#
# html_title = 'test-template-plugin v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'test_template_plugin'),
                os.path.join(root_path, 'test_template_plugin/migrations')])
